...
int main(void)
{
  ...
  /* USER CODE END 2 */
	...
	NVIC_SetPriority(EXTI0_1_IRQn, 1); // this will starve the systick interupt, it is higher priority
	
	// Set priority of SysTick timer
	NVIC_SetPriority(SysTick_IRQn, 2); // this interupt will be handled *after* the button interupt finishes
